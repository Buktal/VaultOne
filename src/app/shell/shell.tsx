...
// Logo: three stacked token bars, width-descending + brand/输入/输出 colors —
// echoes the token-first stacked-area core (ADR-0011) and matches prototype
// v10's mark. Uses palette vars so it recolors with the theme.
...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="bg-background text-foreground flex h-screen w-screen items-stretch gap-4 overflow-hidden pb-4 pl-4 pt-4">
      <aside
        className={cn(

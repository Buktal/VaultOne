// View state: no react-router; desktop single-window, view switch via slice.
// Lightweight mode: the same main window morphs between the full
...
/** The two lightweight sub-shapes: the 5-field glance card
